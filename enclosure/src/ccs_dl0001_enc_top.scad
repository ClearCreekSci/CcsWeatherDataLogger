...
module pi_top_box_with_ventilation() {
    difference() {
        ...
        // ventilation hole
        translate([0,4,BOTTOM_WALL_HEIGHT-(0.5*BOTTOM_WALL_HEIGHT)]) {
            cube([PI_HOLE_CENTERS_LONG_AXIS-6,18,BOTTOM_WALL_HEIGHT+0.2],center=true); 
        }
...
module bme280_top_box_with_header_cutout() {
    ...
    difference() {
        ...
        translate([-0.25,-0.25*BME280_HOLE_CENTERS_SHORT_AXIS-1,BOTTOM_WALL_HEIGHT-(0.5*BOTTOM_WALL_HEIGHT)]) {
            cube([BME280_HOLE_CENTERS_LONG_AXIS+7.5,BME280_HOLE_CENTERS_SHORT_AXIS+2.0,BOTTOM_WALL_HEIGHT+0.2],center=true); 
        }
    }
}
